/**
 * @file bl_enter_bl.h
 * @brief APP CAN2 RX → request bootloader via SRAM magic + SystemReset (F407).
 * @see can-bootloader/Stm32F407_CAN2_Bootloader/Bootloader/Inc/bl_enter_bl.h
 */
...
#define BL_SHARED_MAGIC_ADDR   (0x2001BFF0UL)
#endif
